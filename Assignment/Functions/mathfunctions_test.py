#YUANBO PANG
# This is a program that tests the four functions include reciprocal, mean, geometric mean, and harmonic mean.
...
def harmonic_mean(x, y, z):
    return 3 / (reciprocal(x) + reciprocal(y) + reciprocal(z))
